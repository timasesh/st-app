// Мобильная навигация для student_page - улучшенная версия
...
// Настройка мобильной нижней навигации
function setupMobileBottomNav() {
  ...
  mobileNavItems.forEach((item) => {
    item.addEventListener("click", function (e) {
      ...
      // Обновляем активный класс в мобильной навигации
...
function initializeMobileNavigation() {
  ...
  const cards = document.querySelectorAll(
    ".course-card-modern, .rating-card, .quiz-card, .request-card",
  );
